...
class Markdown
{
     ...
     *
     * @param string $raw Markdown-formatted string
     *
     * @return string
     */
     ...
     *
     * @param string $text Partially transformed HTML text
     *
     * @return string
     */
    ...
    protected function hashHTMLBlocks($text)
    {
        ...
        $block_tags_b_re = 'p|div|h[1-6]|blockquote|pre|table|dl|ol|ul|address|'.
                           'script|noscript|form|fieldset|iframe|math|article|aside|'.
     ...
     *
     * The $boundary argument specifies which character should be used to surround
     * the token. By convension, "B" is used for block elements that needs not
     * to be wrapped into paragraph tags at the end, ":" is used for elements
     * that are word separators and "X" is used in the general case.
     *
     * @param string $text     Text to hash
     * @param string $boundary Character to surround text
     *
     * @return string
     */
    ...
    /**
     * doAnchors_inline_callback
     *
     * @see markdown::doAnchors_reference_callback
     * @param array $matches Partially transformed HTML text
     *
     * @return string
     */
    ...
    /**
     * doImages_inline_callback
     *
     * @see markdown::doImages_reference_callback
     * @param array $matches Matches found
     *
     * @return string
     */
     ...
     *
     * @param string $list_str      The list
     * @param string $marker_any_re Any HTML markers
     *
     * @return string
     */
     ...
     *
     * @param string $code Partially transformed HTML text
     *
     * @return string
     */
     ...
     *
     * @param string $str Partially transformed HTML text
     *
     * @return string
     */
     ...
     * @param string &$str  String from parseSpan
     *
     * @return string
     */
     ...
     * @return string
     */
    function detab_callback($matches)
    {
        $line = $matches[0];
     ...
     * @return string
     */
    function unhash_callback($matches)
    {
